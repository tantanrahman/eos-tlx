                        ...
                        <div class="card ">
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" name="apikey[0]"
                                            value="{{ $apikey + $nextId }}" readonly>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" name="status_eng" readonly
                                            value="Prepared at TLX Office">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="marketing_id">Marketing*</label>
                                        <select name="marketing_id"
                                            class="form-control @error('marketing_id') is-invalid @enderror"
                                            id="select2dropmark" data-width="100%">
                                            <option></option>
                                    ...
                                    <div class="form-group col-md-12" id="customer-country-section">
                                        ...
                                        <select name="country_id[0]" class="form-control"
                                            id="select2countryshipshipment" data-width="100%">
                                            <option></option>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="city_name[0]" type="text"
                                            class="form-control typeaheadCity @error('city_name') is-invalid @enderror"
                                            autocomplete="nope">
                                        @error('city_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-row">
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" name="id[1]"
                                            value="{{ $nextId + 1 ?? '' }}" readonly>
                                    </div>
                                    <div>
                                        <input type="hidden" class="form-control" name="apikey[1]"
                                            value="{{ $apikey + $nextId + 1 }}" readonly>
                                    </div>
                                    <div>
                                        <input type="hidden" class="form-control" name="group[]" value="consignee"
                                            readonly>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12" id="customer-country-section">
                                        ...
                                        <select name="country_id[1]" class="form-control" id="select2countryconshipment"
                                            data-width="100%">
                                            <option></option>
                                            @foreach($countries as $country)
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="city_name[1]" id="city-1" type="text"
                                            class="form-control @error('con_city_name') is-invalid @enderror"
                                            autocomplete="off">
                                        @error('con_city_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input oninput="this.value = this.value.toUpperCase()" type="text" name="values"
                                            ...
                                            value="{{ old('values') }}" autocomplete="off">
                                        @error('values')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="redoc_connote"
                                            ...
                                            value="{{ old('redoc_connote') }}" autocomplete="off">
                                        @error('redoc_connote')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="modal"
                                            class="form-control uang @error('modal') is-invalid @enderror"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="ongkir"
                                            class="form-control uang @error('ongkir') is-invalid @enderror"
                                            value="{{ old('ongkir') }}" autocomplete="off">
                                        @error('ongkir')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
