    ...
    <main>
        ...
        <table border="1" style="width: 100%" cellpadding="3" cellspacing="0" class="page-break">
                ...
                <td>
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td>A.2. Name</td>
                            <td>:</td>
                            <td>{{ $items->ship_company_name === null ? $items['ship_name'] ." / ". $items->marketing : $items->ship_company_name ." / ". $items['ship_name'] ." / ". $items->marketing }}
                            </td>
                        </tr>
                        <tr>
                            <td>A.3. Address</td>
                            <td>:</td>
                            <td>{{ $items['ship_address'] }} {{ $items['ship_city_name'] }}
                                {{ $items['ship_cou_name'] }}</td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td width="10">:</td>
                            <td>{{ $items->con_company_name === null ? $items['con_name'] : $items->con_company_name ." / ". $items['con_name'] }}
                            </td>
                        </tr>
                        <tr>
                            <td>B.2. Address</td>
                            <td>:</td>
                            <td>{{ $items['con_address'] }} {{ $items['con_city_name'] }} {{ $items['con_cou_name'] }}
                            </td>
                        </tr>
                        <tr>
                ...
                <td rowspan="3"
                    style="border-top-color: white; font-size:7; padding-bottom: -7% !important; padding-top: -1% !important; padding-right:20px !important; text-align: justify;">
                    <ul>
                        <li>
                            SAAT PENGIRIM MENGGUNAKAN JASA <b>{{ $getUser[0]->op_name }}</b> BERARTI BAIK PENGIRIM,
                            PENERIMA, DAN ATAU SEMUA PIHAK YANG BERKEPENTINGAN TERHADAP BARANG KIRIMAN TERSEBUT SEPAKAT
                            UNTUK MENYETUJUI SYARAT DAN KETENTUAN YANG BERLAKU DI <b>{{ $getUser[0]->op_name }}</b>.
                        </li>
                        <li>
                            DILARANG UNTUK MENGIRIM BINATANG HIDUP, UANG TUNAI, SURAT-SURAT BERHARGA,PERHIASAN MEWAH DAN
                            BARANG –BARANG BERHARGA, SENJATA API/TAJAM, NARKOTIKA DAN OBAT-OBATAN TERLARANG,
                            BARANG-BARANG BERACUN, BARANG MUDAH MELEDAK, BARANG-BARANG TERLARANG DAN ATAU YANG MELANGGAR
                            HUKUM DINEGARA ASAL ATAU NEGARA TUJUAN.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            SEBESAR NILAI BARANG YANG DI DEKLARASIKAN PADA RESI PENGIRIMAN ATAU MAKSIMUM Rp. 1.000.000,-
                            (SATU JUTA RUPIAH) DAN SEBESAR ONGKOS KIRIM YANG SUDAH DIBAYARKAN ATAU MAKSIMUM
                            Rp.1.000.000,- (SATU JUTA RUPIAH) BILAMANA TERJADI KEHILANGAN YANG SUDAH TERKONFIRMASI ATAS
                            BARANG YANG DIKIRIM.
                        </li>
                        <li>
                            UNTUK KIRIMAN DENGAN NILAI BARANG TERTENTU YANG DIANGGAP BERNILAI OLEH PENGIRIM, PENGIRIM
                            DISARANKAN MENGASURANSIKAN BARANG KIRIMANNYA DENGAN MENGHUBUNGI PERUSAHAAN ASURANSI YANG
                            MENYEDIAKAN ASURANSI YANG DIPERLUKAN PENGIRIM ATAS BARANG KIRIMANNYA.
                        </li>
                    </ul>
                    </tdr>
            </tr>
            ...
            <tr>
                <td rowspan="3" style="border-top-style: hidden;">
                    <table class="center" border="1"
                        style="width: 100%; solid black; margin-left: 10; margin-right: 10;" cellpadding="3">
                        <tr>
                            <th><b>Quantity</b></th>
                            <th><b>Length</b></th>
                            <th><b>Width</b></th>
                    ...
                    <p style="text-align: center; font-size:14; border-top-style: hidden"><b>{{ $items->partner }}</b>
                    </p>
                </td>
