...
<body>
    <header>
        <table cellpadding="1" cellspacing="0" style="width:100%">
            <tr>
                <td width="100" rowspan="3"><img src="{{ url("storage/officeprofile/".$getUser[0]->photo) }}"
                        style="width:90;"></td>
    ...
    <main>
                ...
                <td>
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="border-bottom-style: solid">{{ $getShipment[0]->ship_company_name }} /
                                {{ $getShipment[0]->ship_name }}
                            </td>
                        </tr>
                        <tr>
                            <td>Address :</td>
        ...
        <br />
        <br />
        <table style="width: 100%; border-collapse:collapse; font-size: 15x;" border="1" cellpadding="1"
            cellspacing="1">
            <tr align="center">
                <td><b>QUANTITY</b></td>
            ...
            <tr>
                ...
                <td style="text-align: right">{{ $details->length }} cm x {{ $details->width }} cm x
                    {{ $details->height }} cm</td>
