...
Route::prefix('admin')->middleware('auth')->name('admin.')->group(function () {
    ...
    Route::get('printGdex/{shipment}', [App\Http\Controllers\Admin\PrintController::class, 'printgdexprod'])->name('printgdexprod');
...
Route::get('/getTrackChoir/{data}', [App\Http\Controllers\Admin\ApiEksContoller::class, 'getTrackChoir'])->name('getTrackChoir');